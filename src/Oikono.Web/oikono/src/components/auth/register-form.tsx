        ...
        <form className={cn("flex flex-col gap-6", className)} onSubmit={form.handleSubmit(onSubmit)} {...props}>
            ...
            <div className="grid gap-6">
                <div className="grid gap-3">
                    <FormLabel className="text-left" htmlFor="firstName" invalid={!!form.formState.errors.firstName}>First
                        name</FormLabel>
                    <Input id="firstName" autoComplete="given-name" {...form.register("firstName")} />
                    <FormMessage
                        className="text-left">{form.formState.errors.firstName?.message as string}</FormMessage>
                </div>
                <div className="grid gap-3">
                    <FormLabel className="text-left" htmlFor="lastName" invalid={!!form.formState.errors.lastName}>Last
                        name</FormLabel>
                    <Input id="lastName" autoComplete="family-name" {...form.register("lastName")} />
                    <FormMessage className="text-left">{form.formState.errors.lastName?.message as string}</FormMessage>
                </div>
                <div className="grid gap-3">
                    <FormLabel className="text-left" htmlFor="email"
                               invalid={!!form.formState.errors.email}>Email</FormLabel>
                ...
                <div className="grid gap-3">
                    <FormLabel className="text-left" htmlFor="password"
                               invalid={!!form.formState.errors.password}>Password</FormLabel>
